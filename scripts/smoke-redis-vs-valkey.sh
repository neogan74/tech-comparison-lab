...
COMPOSE_FILE="$REPO_ROOT/deployments/docker-compose/cache/docker-compose.yml"
EXPERIMENT_DIR="$REPO_ROOT/experiments/cache/redis-vs-valkey"

log() {
  echo "[smoke-redis-valkey] $*"
}
