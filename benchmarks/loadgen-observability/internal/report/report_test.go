...
func TestComputePercentiles(t *testing.T) {
	...
	r := Compute("prometheus", "write", 10000000, 5, durs, 5*time.Second)
	...
	if r.ThroughputOps < 1999990 || r.ThroughputOps > 2000010 {
		t.Errorf("throughput = %.2f, want ~2000000", r.ThroughputOps)
	}
}

func TestComputeEmpty(t *testing.T) {
	r := Compute("victoriametrics", "instant-sum", 0, 0, nil, 0)
